...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart2 = dcc.Graph(
            figure = px.line(average_sales,
                ...
                y = 'Automobile_Sales',
                color = 'Vehicle_Type',
                title = "Average Automobile Sales Trend Vehicle-wise during Recession"))
        ...
        R_chart3 = dcc.Graph(
            figure = px.pie(exp_rec,
                ...
                names = 'Vehicle_Type',
                title = "Expenditure Share of Each Vehicle Type during Recession Periods"))

        # Plot 4 bar chart for the effect of mean unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure = px.bar(unemp_rec, 
                ...
                title = "Vehicle- and Sales-Wise Average Unemployment Rate during Recession Periods"))
    ...
    # Yearly Statistic Repot Plots                             
        ...
        yas_m = yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(
            figure = px.line(yas_m, 
                x = 'Month',
                y = 'Automobile_Sales',
                title = "Total Monthly Automobile Sales fluctuation in the year {}".format(input_year) ))
        ...
        Y_chart4 = dcc.Graph(
            figure = px.pie(exp_data,
                values = 'Advertising_Expenditure',
                names = 'Vehicle_Type',
                title = "Expenditure Share of Each Vehicle Type in the year {}".format(input_year) ))
